...
$config = [
    'app' => [
        'classes'      => [
            'Common\\Authentication\\UserFromMySQL' => $authDir . '/MySQLUser.php',
            'Common\\Authentication\\UserThatsFileLoaded' => $authDir . '/FileBasedUser.php',
            'Common\\Authentication\\UserStoredInMemory'  => $authDir . '/InMemoryUser.php',
